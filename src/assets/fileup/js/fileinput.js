...
(function(factory) {
    ...
    FileInput.prototype = {
        ...
        _initUploadSuccess: function(out, $thumb, allFiles) {
            var self = this,
                append, data, index, $div, $newCache, content, config, tags, i;
        ...
        _initPreviewActions: function() {
            ...
            $preview.find(btnRemove).each(function() {
                ...
                var $frame = $el.closest($h.FRAMES),
                    ...
                    settings, params, index = $frame.attr('data-fileindex'),
                    config, extraData;
        ...
        _updateFileDetails: function(numFiles) {
            var self = this,
                ...
                n = self.isAjaxUpload ? fileStack.length : numFiles,
        ...
        _validateMinCount: function() {
            var self = this,
                len = self.isAjaxUpload ? self.getFileStack().length : self._inputFileCount();
        ...
        _setCaption: function(content, isError) {
            var self = this,
                title, out, icon, n, cap, stack = self.getFileStack();
        ...
        _change: function(e) {
            ...
            var $el = self.$element,
                ...
                tfiles = [],
                files = isDragDrop ? arguments[1] : $el.get(0).files,
                total,
                maxCount = !isAjaxUpload && $h.isEmpty($el.attr('multiple')) ? 1 : self.maxFileCount,
                len, ctr = self.filestack.length,
        ...
        readFiles: function(files) {
            ...
            readFile = function(i) {
                ...
                var node = ctr + i,
                    ...
                    typ, chk, typ1, typ2,
                    caption = file && file.name ? self.slug(file.name) : '',
                    fileSize = (file && file.size || 0) / 1000,
                    fileExtExpr = '',
                    previewData = file ? $h.objUrl.createObjectURL(file) : null,
                    fileCount = 0,
                    strTypes = '',
                    func, knownTypes = 0,
